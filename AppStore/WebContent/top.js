(function(){
	  ...
	  homeApp.controller('appList',['$http','$window',function($http,$window){
		  ...
		  var req = {
				  method: 'GET',
				  url: "http://localhost:8080/AppStore/app/",
				  headers: {
		  ...
		  this.selectApp = function(app){ 
			  ...
			  var reqest = {
					  method: 'POST',
					  url: "http://localhost:8080/AppStore/app/getRecom/similarapp/",
...
//			  $http.get('http://localhost:8080/AppStore/app/getRecom/similarapp/')
